...
import { type IDocument, INode, NodeSelectionHandler, PubSub } from "@chili3d/core";
...
export class ShowPropertyEventHandler extends NodeSelectionHandler {
    ...
    protected readonly handleSelectionChanged = (_doc: IDocument, selected: INode[], _unselected: INode[]) => {

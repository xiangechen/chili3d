...
export default {
    ...
    translation: {
        ...
        "command.boolean.fuse": "合并",
        "command.convert.fuse": "融合",
        "command.convert.prism": "拉伸",
        ...
        "command.modify.removeSubShapes": "删除子形状",
